...
- **Phase 5 — Hardening (post-v1):** _in progress._
  ...
  - **Feedback link:** a "Send feedback" link in the chat header and on the key screen opens a pre-filled **GitHub issue** on the repo (`FeedbackLink.tsx`) — no backend or third party. User chose GitHub issues over mailto/forms.
